...
function preload() {
  ...
  soundFormats('mp3');
  FireBase = loadSound("sounds/mla/FireBase.mp3");
  FireBlast = loadSound("sounds/mla/FireBlast.mp3");
  WaterBase = loadSound("sounds/mla/WaterBase.mp3");
  IceShard = loadSound("sounds/mla/IceShard.mp3");
  EarthWall = loadSound("sounds/mla/EarthWall.mp3");
  EarthStones = loadSound("sounds/mla/EarthStones.mp3");
  AirBase = loadSound("sounds/mla/AirBase.mp3");
  AirBall = loadSound("sounds/mla/AirBall.mp3");
