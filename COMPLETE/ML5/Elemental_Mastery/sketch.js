...
function modelLoaded() {
    ...
    // 기존: handpose.on("hand", gotHands);
    // 수정: 여러 손을 동시에 추적하려면 "predict" 이벤트 사용
...
function gotHands(results) {
    // 여러 손이 인식되면 이곳으로 배열 형태의 result가 들어옴
    hands = results;
    // console.log(hands); // 디버깅 시 확인
}
...
function getHandCoordinates() {
    ...
    // 손이 2개 이상일 때 (2개를 초과하더라도 일단 앞의 2개만 사용 가능)
